...
curl -X POST "https://api.denkers.co/queue/" -H "Content-Type: application/json" -H "x-token: 6b1f9eeb7e3a1f6e3b3f1a2c5a7d9e1b" -d '{ "user_id": 1, "raw_text": "DV Elaine in Rose Gold size 11" }'
